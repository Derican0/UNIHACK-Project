  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.extraTasksContainer}>
        <Text style={styles.extraTask}>🌿 Capture a close-up of a leaf or fear the wrath of Snoopy</Text>
      </View>
      <View style={styles.extraTasksContainer}>
        <Text style={styles.extraTask}>🐦 Snap a picture of a bird or get cut into a million pieces</Text>
      </View>
      <View style={styles.extraTasksContainer}>
        <Text style={styles.extraTask}>🌊 Find a water body nearby or you will drown the next time you swim</Text>
      </View>
...
const styles = StyleSheet.create({
  ...
  taskTitle: {
    ...
    textShadowColor: 'rgba(255, 0, 0, 0.7)', // Shadow effect
